...
import com.example.iiui_project.DriverAdapter.MyDataAdapterViewUSer;
...
//        setSupportActionBar(toolbar);
            ...
            public void onDataChange(@NonNull final DataSnapshot dataSnapshot) {
                ...
                for( DataSnapshot dataSnapshot1 : dataSnapshot.getChildren() ){
                    ...
                    AppUser driverConstructor = dataSnapshot1.getValue(AppUser.class) ;
                     if(driverConstructor.getUsertype().equals("User")){
                 ...
                 Adapter = new MyDataAdapterViewUSer(ViewUserActivity.this,StoreDriverList);
                ...
                ItemTouchHelper itemTouchHelper = new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0,  ItemTouchHelper.LEFT) {
                    ...
                    public void onChildDrawOver(@NonNull Canvas c, @NonNull RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
                        ...
                        new RecyclerViewSwipeDecorator.Builder(ViewUserActivity.this , c ,recyclerView , viewHolder ,dX, dY , actionState , isCurrentlyActive )
                                .addSwipeRightBackgroundColor(ContextCompat.getColor(ViewUserActivity.this , R.color.colorAccent))
                                .addSwipeRightActionIcon(R.drawable.ic_delete_black_24dp)
                                .addBackgroundColor(ContextCompat.getColor(ViewUserActivity.this , R.color.colorAccent)).addSwipeLeftBackgroundColor((ContextCompat.getColor(ViewUserActivity.this , R.color.green))).addSwipeLeftActionIcon(R.drawable.ic_call_black)
    ...
    private void CAllByPhone(String getNodeAtPosition) {
        ...
        if(!getNodeAtPosition.isEmpty()){
            ...
            if (ActivityCompat.checkSelfPermission(ViewUserActivity.this,
    ...
    private boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(ViewUserActivity.this, Manifest.permission.CALL_PHONE);
    ...
    private void requestPermission() {
        ...
        ActivityCompat.requestPermissions(ViewUserActivity.this,new String[]{Manifest.permission.CALL_PHONE}, 1);
