...
public class UserUpdateActivityDriver extends AppCompatActivity {
...
LoadingDialog loadingDialog ;
   ...
   ImageView  UpdateLocationButton ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new LoadingDialog(UserUpdateActivityDriver.this);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()){
                    ...
                    if(Keys.equals(usersModelClass.getPushid())){
                        ...
                        CarColor = usersModelClass.getCarcolor() ;
            ...
            public void onClick(View v) {
                ...
                if(resulturi==null) {
                    ...
                    AppUser usersModelClass = new AppUser(
                            UserName, Emails, Password, Cnic,  Phone,Age, Lattitude, Longitude,  picUri,  status, "Driver", "None", "None ", Keys, "None", City  , Carnumber
                    );
