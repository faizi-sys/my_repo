...
import com.example.iiui_project.DriverAdapter.MyDataAdapterForDeriveViewOnly;
...
public class ViewDerives extends AppCompatActivity {
    FirebaseAuth mAuth ;
    FirebaseUser user ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserDataBaseReferenceDrive.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull final DataSnapshot dataSnapshot) {
                ...
                MyDataAdapterForDeriveViewOnly Adapter = new MyDataAdapterForDeriveViewOnly(ViewDerives.this,StoreDriverList);
                ...
                ItemTouchHelper itemTouchHelper = new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0,  ItemTouchHelper.RIGHT) {
                    ...
                    public void onChildDrawOver(@NonNull Canvas c, @NonNull RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
                        ...
                        new RecyclerViewSwipeDecorator.Builder(ViewDerives.this , c ,recyclerView , viewHolder ,dX, dY , actionState , isCurrentlyActive )
                                .addSwipeRightBackgroundColor(ContextCompat.getColor(ViewDerives.this , R.color.colorAccent))
                                .addSwipeRightActionIcon(R.drawable.ic_delete_black_24dp)
                                .addBackgroundColor(ContextCompat.getColor(ViewDerives.this , R.color.colorAccent)).addSwipeLeftBackgroundColor((ContextCompat.getColor(ViewDerives.this , R.color.green))).addSwipeLeftActionIcon(R.drawable.ic_call_black)
