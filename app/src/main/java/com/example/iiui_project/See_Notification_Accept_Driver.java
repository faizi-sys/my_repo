...
public class See_Notification_Accept_Driver extends AppCompatActivity {
                ...
                for(DataSnapshot dataSnapshot1 :dataSnapshot.getChildren())
                 {
                     ...
                     if(user.getUid().equals(notificationFromUser.getDriverId()) || user.getUid().equals(notificationFromUser.getReckey())) {
                         notificationFromUserList.add(notificationFromUser);
                     }

                }
                MyDataAdapterForResponseFromDriverAdapter myDataAdapterForNotification =
                        new MyDataAdapterForResponseFromDriverAdapter(See_Notification_Accept_Driver.this , notificationFromUserList);
