...
public class UpdateLocationActvityUser extends FragmentActivity implements OnMapReadyCallback {
    ...
    FirebaseAuth mAuth ; FirebaseUser user ;
    ...
    private void addClickListener(GoogleMap map) {
        map.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng point) {
                ...
                new AlertDialog.Builder(UpdateLocationActvityUser.this)
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                ...
                                try {
                                    AppUser usersModelClass = new AppUser(
                                            UserName, Emails, Password, Cnic,  Phone,Age, lat, longi,  picUri,  status, "User", "None", "None ", PushKey, "None", City  , CarNumber
                                    );
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        try {
                            AppUser usersModelClass = new AppUser(
                                    ...
                                    UserName, Emails, Password, Cnic,  Phone,Age, Lattitude, Longitude,  picUri,  status, "User", "None", "None ",getIntent().getStringExtra("pushkey") , "None", City  , CarNumber);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()){
                    ...
                    if(user.getUid().equals(usersModelClass.getPushid())){
                        ...
                        Toast.makeText(UpdateLocationActvityUser.this, "ok", Toast.LENGTH_SHORT).show();
