...
public class UserUpdateActivityUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UpdateLocationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext() , UpdateLocationActvityUser.class);
        ...
        loadingDialog = new LoadingDialog(UserUpdateActivityUser.this);
        ...
        Updatebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(resulturi==null) {
                    ...
                    Toast.makeText(UserUpdateActivityUser.this, "" + "this condition true ", Toast.LENGTH_SHORT).show();
                    AppUser usersModelClass = new AppUser(
                            UserName, Emails, Password, Cnic,  Phone,Age, Lattitude, Longitude,  picUri,  status, "User", "None", "None ", Keys, "None", City , "None"
                    );
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    task.addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            AppUser usersModelClass = new AppUser(
                                    UserName, Emails, Password, Cnic,  Phone,Age, Lattitude, Longitude,  picUri,  status, "User", "None", "None ", Keys, "None", City
