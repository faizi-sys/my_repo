...
public class MyDataAdapter extends RecyclerView.Adapter<MyDataAdapter.ViewHolder> implements Filterable {
    ...
    public MyDataAdapter(Activity context, List<AppUser> list) {
    ...
    public MyDataAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.list_layout_driver_user_view , parent , false) ;
    ...
    @Override
    public void onBindViewHolder(@NonNull final MyDataAdapter.ViewHolder holder, int position) {
        final AppUser driverConstructor = list.get(position);
        holder.Name.setText(driverConstructor.getName()); // ok
        holder.Contact.setText(driverConstructor.getCarNumber()); // ok
        ...
        holder.item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context , ViewDerivesByUser.class);
